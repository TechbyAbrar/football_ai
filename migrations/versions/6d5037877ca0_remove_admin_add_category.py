...
Revision ID: 6d5037877ca0
Revises: 8d9176c7fa8b
Create Date: 2024-03-19 15:47:57.494597
...
def upgrade() -> None:
    ...
    op.add_column('ai_document_chunks', sa.Column('category', sa.String(), nullable=True))
